...
export default function SearchTrip() {
  ...
  function clickHandler(){
    ...
    if(!data.booking.startDateText == "Datum") {
      datum = true
    }
    ...
    if(data.booking.startDateText == "Datum" && appState.booking.chosenDepartureStation == "" && appState.booking.chosenDestinationStation == "") {
      console.log("WRONG")
    }
