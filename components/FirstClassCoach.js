...
export default function FirstClassCoach({ coachToRender, handleClickSeat }) {
  return (
    ...
    <div className="h-screen w-full pt-[50px] ">
      ...
      <div className="bg-gray-600 bg-opacity-70 smh-[320px] md:-[520px] ml-5 mr-5">
        <div className=" text-center text-white pt-[10px] text-[10px] ">

          <div id='slider' className="w-full bg-white bg-opacity-20 overflow-x-scroll scroll whitespace-nowrap scroll-smooth ">
            <div>
              <div className="ml-2 pb-10">
                <div className="inline-grid grid-cols-8">
                  <div >
                    <div className="m-2 border-l-4 border-black" key={coachToRender.coachSeats[0].id}>
                      <button
                  ...
                  <div>
                    <div className="m-2 border-r-4 border-black" key={coachToRender.coachSeats[3].id}>
                      <button
                  ...
                  <div>
                    ...
                    <div className="m-2 border-l-4 border-black" key={coachToRender.coachSeats[7].id}>
                      <button
                ...
                <div className="inline-grid grid-cols-8 mt-9 mr-4">
                  <div>
